...
if(isset($_POST['agregar'])){
	...
	try{
		...
		$stmt = $db->prepare("INSERT INTO doctor (dnidoc, nomdoc,apedoc,codespe,sexo,telefo,fechanaci,correo ,naciona,estado,tipo_sangre) VALUES (:dnidoc, :nomdoc, :apedoc, :codespe, :sexo,:telefo,:fechanaci,:correo,:naciona,:estado, :tipo_sangre)");
