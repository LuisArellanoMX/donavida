...
include_once('../config/dbconect.php'); 
						...
						try {
							$sql = 'SELECT COUNT(*) FROM appointment WHERE coddoc = :id AND estado = 0';
							$stmt = $db->prepare($sql);
							$stmt->bindParam(':id', $id, PDO::PARAM_INT);
							$stmt->execute();
							$num_notification = $stmt->fetchColumn();
							//echo "Número de notificaciones: " . $num_notification;
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								<li>
									<div class="dropdown-title">Tienes <?php echo $num_notification ?> citas pendientes</div>
								</li>
								<li>
								...
								<li>
									<a class="see-all" href="../user_app/mostrar.php">Ver las citas<i class="fa fa-angle-right"></i> </a>
								</li>
							</ul>
						</li>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Perfil del donante</h2>
...
$sql = "SELECT * FROM doctor  WHERE coddoc= '$id'";
									...
									<div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group form-group-default">
												<label>DNI</label>
												<input type="text" class="form-control" value="<?php echo $d->dnidoc; ?>" name="dnipa" placeholder="DNI" placeholder="77764664">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-group-default">
												<label>Nombres</label>
												<input type="email" class="form-control" value="<?php echo $d->nomdoc; ?>" name="nombrep" placeholder="Nombre" >
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-group-default">
												<label>Apellidos</label>
												<input type="text" class="form-control" value="<?php echo $d->apedoc; ?>" name="apellidop"  placeholder="Apellido">
											</div>
										</div>
									</div>
									<div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group form-group-default">
												...
												<input type="text" class="form-control" value="<?php echo $d->tipo_sangre; ?>" name="tipo"  placeholder="Tipo de Sangre">
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group form-group-default">
												...
												<input type="text" class="form-control" value="<?php echo $d->telefo; ?>" name="tele" placeholder="Phone">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-group-default">
							...
							<div class="card card-profile">
								...
								<div class="card-body">
									<div class="user-profile text-center">
										<div class="name"><?php echo $d->nomdoc; ?></div>
										<div class="job">Donante</div>
