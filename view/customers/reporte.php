...
$result = mysqli_query($connString, "SELECT *  FROM customers where cargo = ".$cargo) or die("database error:". mysqli_error($connString));
...
$pdf->Cell($w[4],6,utf8_decode($row['tipo_sangre']),1);
