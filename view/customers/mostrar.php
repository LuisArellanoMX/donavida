										...
										<div class="notif-center">
											<a href="#">
												...
												<div class="notif-content">
													<span class="subject">Jose Lopez</span>
													<span class="block">
														Hola que tal....
													</span>
			...
			<div class="content">
				<div class="page-inner">
					...
					<?php
						...
						try{
							$sql = 'SELECT *  FROM customers where cargo = '.$cargo;
...
$sql2 = "INSERT INTO customers(dnipa,nombrep,apellidop,tele,sexo,edad,cargo,estado,tipo_sangre)VALUES ('$dnipa','$nombrep','$apellidop','$tele','$sexo','$edad','$cargo','1','$tipo_sangre')";
