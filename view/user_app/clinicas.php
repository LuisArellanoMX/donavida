					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<a class="see-all" href="mostrar.php">Ver las citas<i class="fa fa-angle-right"></i> </a>
								</li>
							</ul>
						</li>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="d-flex align-items-center">
										<h4 class="card-title">Clinicas</h4>
									</div>
								</div>
								<div class="card-body">
...
if (isset($_SESSION['id'])) {
	...
	$sql = "SELECT * FROM clinicas where codigo != 0 ORDER BY proximidad";
...
?>
 ...
 <?php
			...
			<td><?php echo $row['proximidad']; ?> KM</td>
			<td> <a href="<?php echo $row['ubicacion'];?>" target="_blank"> <span class="badge badge-danger">Como llegar</span> </a> </td>
