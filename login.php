...
if(isset($_POST['login'])) {
    ...
    if($errMsg == '') {
      try {
$stmt = $connect->prepare('SELECT id, us.nombre, usuario, email,clave, cargo, cl.nombre clinica FROM usuarios us  inner JOIN clinicas cl ON cl.codigo = cargo where usuario=:usuario UNION SELECT coddoc, nomdoc,apedoc, usuario, clave, cargo, cl.nombre clinica FROM doctor inner JOIN clinicas cl ON cl.codigo = cargo where usuario=:usuario');
...
<body>
   <!--  <img class="wave"src="../assets/img/wave.png" alt="">  -->
    ...
    <div class="img">
    <img src="assets/img/donacion-de-sangre.png" alt="">
    </div>
...
?>
    ...
    <button class="btn" name='registrar' type="button" onclick="window.location.href='registro.php';"> Registrar
    </button> 
